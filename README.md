...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-03 09:16`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/202c621e-fbea-4afb-b956-dd9f70319fe1.git
$ cd 202c621e-fbea-4afb-b956-dd9f70319fe1
```
